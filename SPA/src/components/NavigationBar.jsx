    ...
    return (
        <>
            {/* <Navbar bg="primary" variant="dark">
                <a className="navbar-brand" href="/">ConnectAid</a> */}
                <AuthenticatedTemplate>
                    {/* <Nav.Link as={Button} href="/hello">HelloAPI</Nav.Link> */}
                    {/* <Button href="/hello">CallAPI</Button>  CALL API BUTTON */}
                    <div className="ml-auto">
                        ...
                        <Button onClick={() => instance.logoutPopup({ postLogoutRedirectUri: "/", mainWindowRedirectUri: "/" })} className="ml-auto">LOGOUT</Button>
